...
function initializeMessages()
{
	...
	$(".mark").click(function (e)
	{
		...
		}).done(function (res, textStatus, jqXHR)
		{
			...
			$("#msg_" + ele.dataset.msgid).dataset.obj = he.encode(JSON.stringify(msgobj), {
				...
				success: function (data, textStatus, jqXHR)
				{
					...
					if(!error)
					{
						...
						if(!nachricht.read)
						{
							...
							$("#msg_" + nachricht.uid).attr("data-obj", he.encode(JSON.stringify(nachricht), {
								'useNamedReferences': true
							}));
							count++;
						}
...
{
	var ret = [];
	ret.push('<li class="collection-item avatar unselectable msg_' + type + (queuing ? " queuing" : "") + '" data-obj="' + he.encode(JSON.stringify(msg), {
		'useNamedReferences': true
	}) + '" data-msgid="' + msg.uid + '" id="msg_' + msg.uid + '">');
						...
						if(view)
						{
							switch(idx)
							{
								...
								case 3:
									...
									message.title = he.encode($.trim($(this).text()), {
										'useNamedReferences': true
									});
									...
									break;
								case 4:
									message.attention = he.encode($.trim($(this).text()), {
										'useNamedReferences': true
									});
									break;
								case 5:
...
(function (u)
{
	var h = "object" == typeof exports && exports,
		v = "object" == typeof module && module && module.exports == h && module,
		g = "object" == typeof global && global;
	if(g.global === g || g.window === g) u = g;
	var D = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
		E = /[\x01-\x7F]/g,
		F = /[\x01-\t\x0B\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g,
		w = /<\u20D2|=\u20E5|>\u20D2|\u205F\u200A|\u219D\u0338|\u2202\u0338|\u2220\u20D2|\u2229\uFE00|\u222A\uFE00|\u223C\u20D2|\u223D\u0331|\u223E\u0333|\u2242\u0338|\u224B\u0338|\u224D\u20D2|\u224E\u0338|\u224F\u0338|\u2250\u0338|\u2261\u20E5|\u2264\u20D2|\u2265\u20D2|\u2266\u0338|\u2267\u0338|\u2268\uFE00|\u2269\uFE00|\u226A\u0338|\u226A\u20D2|\u226B\u0338|\u226B\u20D2|\u227F\u0338|\u2282\u20D2|\u2283\u20D2|\u228A\uFE00|\u228B\uFE00|\u228F\u0338|\u2290\u0338|\u2293\uFE00|\u2294\uFE00|\u22B4\u20D2|\u22B5\u20D2|\u22D8\u0338|\u22D9\u0338|\u22DA\uFE00|\u22DB\uFE00|\u22F5\u0338|\u22F9\u0338|\u2933\u0338|\u29CF\u0338|\u29D0\u0338|\u2A6D\u0338|\u2A70\u0338|\u2A7D\u0338|\u2A7E\u0338|\u2AA1\u0338|\u2AA2\u0338|\u2AAC\uFE00|\u2AAD\uFE00|\u2AAF\u0338|\u2AB0\u0338|\u2AC5\u0338|\u2AC6\u0338|\u2ACB\uFE00|\u2ACC\uFE00|\u2AFD\u20E5|[\xA0-\u0113\u0116-\u0122\u0124-\u012B\u012E-\u014D\u0150-\u017E\u0192\u01B5\u01F5\u0237\u02C6\u02C7\u02D8-\u02DD\u0311\u0391-\u03A1\u03A3-\u03A9\u03B1-\u03C9\u03D1\u03D2\u03D5\u03D6\u03DC\u03DD\u03F0\u03F1\u03F5\u03F6\u0401-\u040C\u040E-\u044F\u0451-\u045C\u045E\u045F\u2002-\u2005\u2007-\u2010\u2013-\u2016\u2018-\u201A\u201C-\u201E\u2020-\u2022\u2025\u2026\u2030-\u2035\u2039\u203A\u203E\u2041\u2043\u2044\u204F\u2057\u205F-\u2063\u20AC\u20DB\u20DC\u2102\u2105\u210A-\u2113\u2115-\u211E\u2122\u2124\u2127-\u2129\u212C\u212D\u212F-\u2131\u2133-\u2138\u2145-\u2148\u2153-\u215E\u2190-\u219B\u219D-\u21A7\u21A9-\u21AE\u21B0-\u21B3\u21B5-\u21B7\u21BA-\u21DB\u21DD\u21E4\u21E5\u21F5\u21FD-\u2205\u2207-\u2209\u220B\u220C\u220F-\u2214\u2216-\u2218\u221A\u221D-\u2238\u223A-\u2257\u2259\u225A\u225C\u225F-\u2262\u2264-\u228B\u228D-\u229B\u229D-\u22A5\u22A7-\u22B0\u22B2-\u22BB\u22BD-\u22DB\u22DE-\u22E3\u22E6-\u22F7\u22F9-\u22FE\u2305\u2306\u2308-\u2310\u2312\u2313\u2315\u2316\u231C-\u231F\u2322\u2323\u232D\u232E\u2336\u233D\u233F\u237C\u23B0\u23B1\u23B4-\u23B6\u23DC-\u23DF\u23E2\u23E7\u2423\u24C8\u2500\u2502\u250C\u2510\u2514\u2518\u251C\u2524\u252C\u2534\u253C\u2550-\u256C\u2580\u2584\u2588\u2591-\u2593\u25A1\u25AA\u25AB\u25AD\u25AE\u25B1\u25B3-\u25B5\u25B8\u25B9\u25BD-\u25BF\u25C2\u25C3\u25CA\u25CB\u25EC\u25EF\u25F8-\u25FC\u2605\u2606\u260E\u2640\u2642\u2660\u2663\u2665\u2666\u266A\u266D-\u266F\u2713\u2717\u2720\u2736\u2758\u2772\u2773\u27C8\u27C9\u27E6-\u27ED\u27F5-\u27FA\u27FC\u27FF\u2902-\u2905\u290C-\u2913\u2916\u2919-\u2920\u2923-\u292A\u2933\u2935-\u2939\u293C\u293D\u2945\u2948-\u294B\u294E-\u2976\u2978\u2979\u297B-\u297F\u2985\u2986\u298B-\u2996\u299A\u299C\u299D\u29A4-\u29B7\u29B9\u29BB\u29BC\u29BE-\u29C5\u29C9\u29CD-\u29D0\u29DC-\u29DE\u29E3-\u29E5\u29EB\u29F4\u29F6\u2A00-\u2A02\u2A04\u2A06\u2A0C\u2A0D\u2A10-\u2A17\u2A22-\u2A27\u2A29\u2A2A\u2A2D-\u2A31\u2A33-\u2A3C\u2A3F\u2A40\u2A42-\u2A4D\u2A50\u2A53-\u2A58\u2A5A-\u2A5D\u2A5F\u2A66\u2A6A\u2A6D-\u2A75\u2A77-\u2A9A\u2A9D-\u2AA2\u2AA4-\u2AB0\u2AB3-\u2AC8\u2ACB\u2ACC\u2ACF-\u2ADB\u2AE4\u2AE6-\u2AE9\u2AEB-\u2AF3\u2AFD\uFB00-\uFB04]|\uD835[\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDCCF\uDD04\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDD6B]/g,
		k = {
			"\u00c1": "Aacute",
			"\u00e1": "aacute",
			"\u0102": "Abreve",
		...
		I = /[\0-\x08\x0B\x0E-\x1F\x7F-\x9F\uFDD0-\uFDEF\uFFFE\uFFFF]|[\uD83F\uD87F\uD8BF\uD8FF\uD93F\uD97F\uD9BF\uD9FF\uDA3F\uDA7F\uDABF\uDAFF\uDB3F\uDB7F\uDBBF\uDBFF][\uDFFE\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,
		J = /&#([0-9]+)(;?)|&#[xX]([a-fA-F0-9]+)(;?)|&([0-9a-zA-Z]+);|&(Aacute|iacute|Uacute|plusmn|otilde|Otilde|Agrave|agrave|yacute|Yacute|oslash|Oslash|Atilde|atilde|brvbar|Ccedil|ccedil|ograve|curren|divide|Eacute|eacute|Ograve|oacute|Egrave|egrave|ugrave|frac12|frac14|frac34|Ugrave|Oacute|Iacute|ntilde|Ntilde|uacute|middot|Igrave|igrave|iquest|aacute|laquo|THORN|micro|iexcl|icirc|Icirc|Acirc|ucirc|ecirc|Ocirc|ocirc|Ecirc|Ucirc|aring|Aring|aelig|AElig|acute|pound|raquo|acirc|times|thorn|szlig|cedil|COPY|Auml|ordf|ordm|uuml|macr|Uuml|auml|Ouml|ouml|para|nbsp|Euml|quot|QUOT|euml|yuml|cent|sect|copy|sup1|sup2|sup3|Iuml|iuml|shy|eth|reg|not|yen|amp|AMP|REG|uml|ETH|deg|gt|GT|LT|lt)([=a-zA-Z0-9])?/g,
		x = {
			Aacute: "\u00c1",
			aacute: "\u00e1",
			Abreve: "\u0102",
		...
		B = function (a, c)
		{
			...
			var b = {},
				d;
			for(d in c) b[d] = p.call(a, d) ? a[d] : c[d];
			return b
		},
		C = function (a, c)
		{
			var b = "";
			if(55296 <= a && 57343 >= a || 1114111 < a) return c && e("character reference outside the permissible Unicode range"), "\ufffd";
			if(p.call(y, a)) return c && e("disallowed character reference"), y[a];
			var d;
			if(d = c) a: {
				d = -1;
				for(var L = z.length;++d < L;)
					if(z[d] == a)
					{
						d = !0;
						break a
			...
			d && e("disallowed character reference");
			65535 < a && (a -= 65536, b += A(a >>> 10 & 1023 | 55296), a = 56320 | a & 1023);
			return b += A(a)
		},
		q = function (a)
		{
		...
		{
			c = B(c, r.options);
			c.strict && I.test(a) && e("forbidden code point");
			var b = c.useNamedReferences,
				d = c.allowUnsafeSymbols;
			c.encodeEverything ? (a = a.replace(E, function (a)
			{
				return b && p.call(k,
					a) ? "&" + k[a] + ";" : q(a)
			}), b && (a = a.replace(/&gt;\u20D2/g, "&nvgt;").replace(/&lt;\u20D2/g, "&nvlt;").replace(/&#x66;&#x6A;/g, "&fjlig;")), b && (a = a.replace(w, function (a)
			{
				return "&" + k[a] + ";"
			}))) : b ? (d || (a = a.replace(l, function (a)
			{
				return "&" + k[a] + ";"
			})), a = a.replace(/&gt;\u20D2/g, "&nvgt;").replace(/&lt;\u20D2/g, "&nvlt;"), a = a.replace(w, function (a)
			{
				return "&" + k[a] + ";"
			})) : d || (a = a.replace(l, q));
			return a.replace(D, function (a)
			{
				...
				a = a.charCodeAt(1);
				return "&#x" + (1024 * (d - 55296) + a - 56320 + 65536).toString(16).toUpperCase() +
					";"
			}).replace(F, q)
		};
	r.options = {
	...
	var n = function (a, c)
	{
		c = B(c, n.options);
		var b = c.strict;
		b && H.test(a) && e("malformed character reference");
		return a.replace(J, function (a, f, m, g, k, h, n, l)
		{
			if(f) return a = f, b && !m && e("character reference was not terminated by a semicolon"), C(a, b);
			if(g) return b && !k && e("character reference was not terminated by a semicolon"), a = parseInt(g, 16), C(a, b);
			if(h)
			{
				m = h;
				if(p.call(x, m)) return x[m];
				b && e("named character reference was not terminated by a semicolon");
				return a
			}
			m = n;
			if(l && c.isAttributeValue) return b && "=" == l && e("`&` did not start a character reference"), a;
			b && e("named character reference was not terminated by a semicolon");
			return K[m] + (l || "")
		})
	};
